...
public abstract class Constantes {
	...
	public static String URL_SERVIDOR = "http://192.168.2.100:8888";
	public static final int TIMEOUT = 3000;
	public static final int TEMPO_VERIFICAR_DATA_DEVOLUCAO = 1; //minutos
	...
	//public static final String TAG_RE = re.compile(r'<[^>]+>')
}
